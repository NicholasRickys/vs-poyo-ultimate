...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Extra Note 1', 'FOR MULTI OPPONENT, THIS NOTE DOES ABSOLUTELY NOTHING AND SHOULD BE USED FOR IDENTIFICATION PURPOSES'],
		['Extra Note 2', 'FOR MULTI OPPONENT, THIS NOTE DOES ABSOLUTELY NOTHING AND SHOULD BE USED FOR IDENTIFICATION PURPOSES'],
		['Extra Note 3', 'FOR MULTI OPPONENT, THIS NOTE DOES ABSOLUTELY NOTHING AND SHOULD BE USED FOR IDENTIFICATION PURPOSES'],
		['Extra Note 4', 'FOR MULTI OPPONENT, THIS NOTE DOES ABSOLUTELY NOTHING AND SHOULD BE USED FOR IDENTIFICATION PURPOSES']
	];
