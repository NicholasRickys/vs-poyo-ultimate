...
class CharacterSelect extends MusicBeatState
{
	...
	var characters:Array<CharacterData> = [
		...
		},
		{
			...
			facts: [
				...
				'His father, a military veteran, taught him to fight at the age of 8, due to his crazy mother.',
				'He\'s adopted!',
				'This isn\'t the canon Poyo, that Poyo will be starring in other media than FNF.'
			],
			char: null,
			offset_x: -250,
			offset_y: -150
		...
		{
			name: "Nafri Nafri Nafri Nafri Nafri Nafri The 9th",
			facts: [
				...
				"His main weapon is a crowbar, he stole it from Poyo\'s place without knowing it was his or his dad\'s. Poyo didn\'t care, though."
			],
			char: null,
			offset_x: -125,
			offset_y: -65
	...
	override function update(elapsed:Float)
	{
		...
		// lmfao check if it faded to white or smth idk
		if (hasGivenBack)
		{
